const Profil = () => {
    return (
        <div className="flex flex-col md:flex-row items-center justify-center mt-10 px-4 md:px-24">
            ...
            <div className="pt-6 md:pt-0 md:pl-5 flex justify-center items-center w-full md:w-[535px] h-auto md:h-[515px]">
                <img src="/profil.png" alt="Profil George" className="w-full max-w-xs md:max-w-full h-auto" />
            </div>
        </div>
    );
};
